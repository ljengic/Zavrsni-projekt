...
procesorsko vrijeme tako da se svakom zadatku iz liste dodjeljuje jedan vremenski odsječak procesorskog vremena (\textit{engl. tick}).
...
Izvršavanje zadataka u SRSV-ima podijeljeno je u vremenske odsječke. U određenim vremenskim intervalima (\textit{engl. ticks}) prekida se izvođenje poslova i 
...
treba prekinuti njegovo daljnje izvršavanje.
 ...
 (\textit{engl. job killing}). Time se podiže kvaliteta usluge, jer je osigurano da poslovi koji se nikako neće 
