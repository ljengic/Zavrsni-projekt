...
Za primjer možemo uzeti autonomni mobilni robot\cite{clanak_3} koji ima sustav za izbjegavanje prepreka. Za siguran rad ključno je uspješno izvođenje zadataka
